...
RUN apt-get update && apt-get install -y --no-install-recommends git && pip install --upgrade pip && pip install flake8 flake8-bugbear git+https://github.com/prussyuval/lintly markupsafe==2.0.1
